...
namespace OpenIso8583Net.Tests
{
    ...
    public class FixedFieldTests
    {
        ...
        {
            var field = new Field(2, new FieldDescriptor(new FixedLengthFormatter(6), FieldValidators.A, Formatter.Formatters.Ascii));
            var msg = new byte[10];
            msg[2] = 65;
            msg[3] = 65;
            msg[4] = 65;
        ...
        {
            var field = new Field(2, new FieldDescriptor(new FixedLengthFormatter(6), FieldValidators.Ans, Formatter.Formatters.Ascii));
            field.Value = "AAAAAA";
        ...
        {
            var f = new Field(2, new FieldDescriptor(new FixedLengthFormatter(6), FieldValidators.Ans, Formatter.Formatters.Ascii));
            f.Value = "12345";
            try
            {
                f.ToMsg();
        ...
        public void TestFixedFieldImplementsValidatorPack()
        {
            ...
            var f = new Field(2, new FieldDescriptor(new FixedLengthFormatter(6), FieldValidators.N, Formatter.Formatters.Ascii));
            f.Value = "12345a";
            try
            {
                f.ToMsg();
